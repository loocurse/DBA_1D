...
def create_list_of_coys(num_of_data):
    '''Returns a list of companies that have the num_of_data data points'''
    output = counts_of_companies.loc[counts_of_companies == num_of_data].index.tolist()
    return output
